...
public class WordFitness {
	...
	public static void loadFiles() {
		...
		InputStream inputStream = WordFitness.class.getResourceAsStream("/javalibrary/fitness/count_1w.txt");
		...
		InputStream inputStream2 = WordFitness.class.getResourceAsStream("/javalibrary/fitness/count_2w.txt");
